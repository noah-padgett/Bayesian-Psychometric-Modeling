########################################################################################################################
# Governing R code to run model checking and comparison for CFA example with one latent varible
...
#   Coda folder
########################################################################################################################
main.folder <- "C:\\BPM\\CFA One Latent Variable\\"
...
########################################################################################################################
  ...
  source(paste(R.code.folder, file.name, sep=""))
  setwd(R.folder)
