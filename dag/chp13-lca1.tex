...
\begin{tikzpicture}[auto,scale=3,
	...
	manifest/.style={text centered, rectangle,draw,thick,inner sep=3pt,minimum height=8mm, minimum width=8mm, text width= 8 mm},
	  plate/.style={draw, shape=rectangle,thick, minimum height=4cm, minimum width=4.5cm, text width=1cm, align=right, inner sep=10pt, inner ysep=10pt, append after command={node[below right= 3pt of \tikzlastnode.north west] {#1}}},
	  plate2/.style={draw, shape=rectangle,thick, minimum height=4cm, minimum width=4.5cm, text width=1cm, align=right, inner sep=5pt, inner ysep=8pt, append after command={node[below left= 3pt of \tikzlastnode.north east] {#1}}},
	  plate3/.style={draw, shape=rectangle,thick, minimum height=4cm, minimum width=4.5cm, text width=1cm, align=right, inner sep=10pt, inner ysep=10pt, append after command={node[above right= 3pt of \tikzlastnode.south west] {#1}}},
...
\node [error]   [above = 0.5cm of t] (gam)   {$\alpha_{\gamma}$};
\node [manifest]   [above = 0.5cm of gam] (gama)   {$\alpha_{\gamma}$};
\node [error]      [below = 1.5cm of x] (a0) {$\pi_{cj}$};
  \node [manifest] [below = 0.75cm of a0] (aj0) {$\alpha_{\pi_c}$};

\node [plate={$i=1, \cdots, N$}] [right= -4cm of x, yshift=1cm] (p) {};
\node [plate2={$j=1, \cdots, J$}] [right= -1.5cm of x, yshift=-1.25cm] (p2) {};
\node [plate3={$c=1, \cdots, C$}] [right= -4cm of a0, yshift=-1cm] (p3) {};
