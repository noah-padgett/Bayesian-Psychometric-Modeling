...
```{r chp2-dag-1, echo=FALSE,fig.align='center',fig.cap='Directed Acyclic Graph (DAG) for the beta-binomial model'}
...
```{r chp2-dag-2, echo=FALSE,fig.align='center',fig.cap='DAG with explicit representation for all beta-binomial model components'}
...
```{r chp2-beta-bin-fit-bugs, warnings=F, message=F,error=F, cache=TRUE}
...
```{r chp2-dag-3, echo=FALSE,fig.align='center',fig.cap='DAG for the beta-bernoulli model'}
knitr::include_graphics(paste0(w.d,'/dag/chp2-beta-bernoulli-plate.png'),
                        auto_pdf = TRUE)
```


```{r chp2-dag-4, echo=FALSE,fig.align='center',fig.cap='DAG with explicit representation for all beta-bernoulli model components'}
...
```{r chp2-beta-bern-fit, warnings=F, message=F, error=F, cahce=TRUE}
...
```{r chp2-beta-bern-fit-bugs, warnings=F, message=F,error=F, cache=TRUE}
