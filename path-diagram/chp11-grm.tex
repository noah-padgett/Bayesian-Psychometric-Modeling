...
\node [manifest]   [below = 1cm of xi] (x4) {$x_4$};
\node [manifest]   [left = 0.25cm of x4] (x3) {$x_3$};
\node [manifest]   [left = 0.25cm of x3] (x2) {$x_2$};
\node [manifest]   [left = 0.25cm of x2] (x1) {$x_1$};
\node [manifest]   [right = 0.25cm of x4] (x5) {$x_5$};
\node [manifest]   [right = 0.25cm of x5] (x6) {$x_6$};
\node [manifest]   [right = 0.25cm of x6] (x7) {$x_7$};
% paths
...
\draw[paths] (xi)  -- (x6.north);
\draw[paths] (xi)  -- (x7.north);
